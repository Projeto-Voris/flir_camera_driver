...
def generate_launch_description():
    ...
    return LaunchDescription([
        LaunchArg('cam_0_name', default_value=['left_camera'],
                  description='camera name (ros node name) of camera 0'),
        LaunchArg('cam_1_name', default_value=['right_camera'],
        ...
        LaunchArg('cam_0_serial', default_value="'16378753'",
                  description='FLIR serial number of camera 0 (in quotes!!)'),
        LaunchArg('cam_1_serial', default_value="'16378754'",
